                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        <div class="p-5">
                            ...
                            <hr>
                            <form id="profForm" class="user" method="post" action="admin_atencion_estudio1.php">
...
if (isset($_GET['dni'])) {
    ...
    $query = "SELECT idServicio, nombre from servicios WHERE nombre LIKE 'Estudio_%' AND idServicio IN (31, 32,40) order by nombre ASC;";
    $result = $conn->query($query);
